(self.webpackChunkadwd_cspims=self.webpackChunkadwd_cspims||[]).push([[2544],{23341:(Y,Z,r)=>{"use strict";r.r(Z),r.d(Z,{CreatePage:()=>Ce,default:()=>Me});var e=r(67294),E=r(66115),o=r(87631),T=r(185),I=r(53979),b=r(11047),P=r(29728),R=r(49066),x=r(41580),B=r(75515),j=r(11276),F=r(74571),y=r(16364),u=r(61467),N=r(67109),Q=r(14916),z=r(27361),he=r.n(z),A=r(41609),w=r.n(A),me=r(86896),h=r(16550),q=r(71997),X=r(18280),ee=r(95428),ie=r(87751),le=r(87561);const ye=le.Ry().shape({name:le.Z_().required(o.I0.required),description:le.Z_().required(o.I0.required)}),ce=q.ZP.div`
...
`,dt=({availableActions:t,isActive:n,isGrey:a,isFormDisabled:s,label:i,onClickToggle:l,pathToData:c})=>{const[d,p]=(0,e.useState)(!1),{formatMessage:m}=(0,F.Z)(),{modifiedData:g,onChangeParentCheckbox:C,onChangeSimpleCheckbox:S}=(0,ee.$_)(),W=()=>{p(G=>!G)},M=()=>{p(!1)},v=h()(g,c.split(".."),{}),f=(0,e.useMemo)(()=>Object.keys(v).reduce((G,J)=>(G[J]=X()(v[J],"conditions"),G),{}),[v]),{hasAllActionsSelected:L,hasSomeActionsSelected:D}=Pe(f),k=(0,e.useMemo)(()=>Wt(t,g,c),[t,g,c]),ne=k.some(({hasConditions:G})=>G);return e.createElement(Ht,{isActive:n},e.createElement(at,{isGrey:a},e.createElement(ot,{isCollapsable:!0,isFormDisabled:s,label:i,checkboxName:c,onChange:C,onClick:l,someChecked:D,value:L,isActive:n},e.createElement(lt,{paddingLeft:2},n?e.createElement(z.Z,null):e.createElement(he.Z,null))),e.createElement(A.k,{style:{flex:1}},k.map(({actionId:G,hasConditions:J,hasAllActionsSelected:H,hasSomeActionsSelected:ge,isDisplayed:ke,isParentCheckbox:oe,checkboxName:be,label:We})=>ke?oe?e.createElement(it,{key:G,justifyContent:"center",alignItems:"center"},J&&e.createElement(ct,null),e.createElement(w.C,{disabled:s,name:be,"aria-label":m({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${We} ${i}`}),onValueChange:Ae=>{C({target:{name:be,value:Ae}})},indeterminate:ge,value:H})):e.createElement(it,{key:G,justifyContent:"center",alignItems:"center"},J&&e.createElement(ct,null),e.createElement(w.C,{disabled:s,indeterminate:J,name:be,onValueChange:Ae=>{S({target:{name:be,value:Ae}})},value:H})):e.createElement(Ue,{key:G}))),d&&e.createElement(V,{headerBreadCrumbs:[i,"Settings.permissions.conditions.conditions"],actions:k,isFormDisabled:s,onClosed:M,onToggle:W})),e.createElement(Ut,null,e.createElement(ce,{onClick:W,hasConditions:ne})))};dt.propTypes={availableActions:o().array.isRequired,isActive:o().bool.isRequired,isGrey:o().bool.isRequired,isFormDisabled:o().bool.isRequired,label:o().string.isRequired,onClickToggle:o().func.isRequired,pathToData:o().string.isRequired};const Kt=dt,Gt=(t,n)=>t.map(a=>{const s=Array.isArray(a.applyToProperties)&&a.applyToProperties.indexOf(n)!==-1&&a.isDisplayed;return{label:a.label,actionId:a.actionId,isActionRelatedToCurrentProperty:s}}),ut=(0,u.ZP)(A.k)`
  width: ${K};
  flex-shrink: 0;
`,zt=(0,u.ZP)(A.k)`
  width: ${Ee};
...
`,Xe=({childrenForm:t,isFormDisabled:n,recursiveLevel:a,pathToDataFromActionRow:s,propertyActions:i,parentName:l,propertyName:c})=>{const{formatMessage:d}=(0,F.Z)(),{modifiedData:p,onChangeParentCheckbox:m,onChangeSimpleCheckbox:g}=(0,ee.$_)(),[C,S]=(0,e.useState)(null),W=v=>{S(f=>f===v?null:v)},M=(0,e.useMemo)(()=>C?t.find(({value:v})=>v===C):null,[C,t]);return e.createElement(en,null,e.createElement(sn,null),t.map(({label:v,value:f,required:L,children:D},k)=>{const ne=k+1<t.length,G=Array.isArray(D),J=C===f;return e.createElement(tn,{key:f,isVisible:ne},e.createElement(_t,null,e.createElement(qt,{color:"primary200"}),e.createElement(A.k,{style:{flex:1}},e.createElement(nn,{level:a,isActive:J,isCollapsable:G},e.createElement(st,{alignItems:"center",isCollapsable:G,...G&&{onClick:()=>W(f),"aria-expanded":J,onKeyDown:({key:H})=>(H==="Enter"||H===" ")&&W(f),tabIndex:0,role:"button"},title:v},e.createElement(O.Z,{ellipsis:!0},ue()(v)),L&&e.createElement(pt,null),e.createElement(Fe,{$isActive:J}))),e.createElement(A.k,{style:{flex:1}},i.map(({actionId:H,label:ge,isActionRelatedToCurrentProperty:ke})=>{if(!ke)return e.createElement(Ue,{key:H});const oe=[...s.split(".."),H,"properties",c,...l.split(".."),f],be=h()(p,oe,!1);if(!D)return e.createElement(gt,{key:ge,justifyContent:"center",alignItems:"center"},e.createElement(w.C,{disabled:n,name:oe.join(".."),"aria-label":d({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${l} ${v} ${ge}`}),onValueChange:Te=>{g({target:{name:oe.join(".."),value:Te}})},value:be}));const{hasAllActionsSelected:We,hasSomeActionsSelected:Ae}=Pe(be);return e.createElement(gt,{key:ge,justifyContent:"center",alignItems:"center"},e.createElement(w.C,{key:ge,disabled:n,name:oe.join(".."),"aria-label":d({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${l} ${v} ${ge}`}),onValueChange:Te=>{m({target:{name:oe.join(".."),value:Te}})},value:We,indeterminate:Ae}))})))),M&&J&&e.createElement(y.x,{paddingBottom:2},e.createElement(Xe,{isFormDisabled:n,parentName:`${l}..${f}`,pathToDataFromActionRow:s,propertyActions:i,propertyName:c,recursiveLevel:a+1,childrenForm:M.children})))}))};Xe.propTypes={childrenForm:o().array.isRequired,isFormDisabled:o().bool.isRequired,parentName:o().string.isRequired,pathToDataFromActionRow:o().string.isRequired,propertyActions:o().array.isRequired,propertyName:o().string.isRequired,recursiveLevel:o().number.isRequired};const on=(0,e.memo)(Xe),rn=t=>t.reduce((a,s)=>(s.isActionRelatedToCurrentProperty&&a.push(s.actionId),a),[]),an=(t,n,a,s,i)=>{const c=rn(t).reduce((d,p)=>{const m=[...a.split(".."),p,"properties",s,i],g=h()(n,m,!1);return d[p]=g,d},{});return Pe(c)},ht=(0,u.ZP)(A.k)`
  width: ${K};
  position: relative;
`,ln=(0,u.ZP)(A.k)`
  height: ${ve};
...
`,y=({title:u,description:N,as:Q="span",togglePosition:z="right",action:he,...A})=>{const{onToggle:w,toggle:me,expanded:h,id:q,size:X,variant:ee,disabled:ie}=(0,I.A)(),le=`accordion-content-${q}`,Se=`accordion-label-${q}`,ye=`accordion-desc-${q}`,ce=X==="M"?6:4,Ce=X==="M"?ce:ce-2,Me=b({expanded:h,disabled:ie,variant:ee}),U={as:Q,fontWeight:X==="S"?"bold":void 0,id:Se,textColor:h?"primary600":"neutral700",ellipsis:!0,variant:X==="M"?"delta":void 0},re=h?"primary600":"neutral600",O=h?"primary200":"neutral200",$=X==="M"?`${32/16}rem`:`${24/16}rem`,_=()=>{ie||(me&&!w?(console.warn('Deprecation warning: Usage of "toggle" prop in Accordion component is deprecated. This is discouraged and will be removed in the next major release. Please use "onToggle" instead'),me()):w&&w())},se=(0,e.jsx)(x.k,{justifyContent:"center",borderRadius:"50%",height:$,width:$,transform:h?"rotate(180deg)":void 0,"data-strapi-dropdown":!0,"aria-hidden":!0,as:"span",background:O,cursor:ie?"not-allowed":"pointer",onClick:_,shrink:0,children:(0,e.jsx)(R.J,{as:E.Z,width:X==="M"?`${11/16}rem`:`${8/16}rem`,color:h?"primary600":"neutral600"})});return(0,e.jsx)(F,{paddingBottom:Ce,paddingLeft:ce,paddingRight:ce,paddingTop:Ce,background:Me,expanded:h,size:X,justifyContent:"space-between",cursor:ie?"not-allowed":"",children:(0,e.jsxs)(x.k,{gap:3,flex:1,maxWidth:"100%",children:[z==="left"&&se,(0,e.jsx)(j,{onClick:_,"aria-disabled":ie,"aria-expanded":h,"aria-controls":le,"aria-labelledby":Se,"data-strapi-accordion-toggle":!0,expanded:h,type:"button",flex:1,minWidth:0,...A,children:(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(T.y,{...U,children:u}),N&&(0,e.jsx)(B.Z,{as:"p",id:ye,textColor:re,children:N})]})}),z==="right"&&(0,e.jsxs)(x.k,{gap:3,children:[se,he]}),z==="left"&&he]})})}},2407:(Y,Z,r)=>{"use strict";r.d(Z,{$:()=>x,O:()=>B});var e=r(85893),E=r(16405),o=r(71997),T=r(63237),I=r(11047),b=r(41580),P=r(75515);const R=(0,o.ZP)(I.k)`
  svg {
    height: ${10/16}rem;
    width: ${10/16}rem;
    path {
